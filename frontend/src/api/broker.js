...
const ENDPOINTS = {
  ...
  ctrader: {
    ...
    connect: '/api/ctrader/connect',
    disconnect: '/api/ctrader/disconnect',
    account: '/api/ctrader/account',
    positions: '/api/ctrader/positions',
    orders: '/api/ctrader/orders',
    order: '/api/ctrader/order',
    quote: '/api/ctrader/quote'
  }
}
...
export const broker = {
  ...
  ctrader: makeBrokerClient('ctrader')
}

export const BROKER_IDS = ['alpaca', 'ibkr', 'mt5', 'ctrader']
