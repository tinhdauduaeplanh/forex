...
const locale = {
  ...
  'brokerAccounts.ctrader.name': 'cTrader',
  'brokerAccounts.ctrader.accessToken': 'Access token / OAuth token',
  'brokerAccounts.ctrader.accessTokenPh': 'Paste the OAuth or app access token',
  'brokerAccounts.ctrader.accountOptional': 'Account ID (optional)',
  'brokerAccounts.ctrader.accountPh': 'Demo or live account ID',
  'brokerAccounts.ctrader.environment': 'Environment',
  'brokerAccounts.ctrader.helpText': 'cTrader supports cloud-friendly OAuth-based access for Forex and CFD accounts. {docs}',
  'brokerAccounts.ctrader.docsLabel': 'Create a cTrader Open API app →',
  ...
  'brokerAccounts.badges.cloud_ready': 'Cloud-ready',
