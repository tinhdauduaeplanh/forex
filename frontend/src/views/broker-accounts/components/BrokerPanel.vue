...
import CTraderConnectForm from './forms/CTraderConnectForm.vue'
...
const DOCS = {
  ...
  ctrader: 'https://help.ctrader.com/open-api/creating-new-app/'
}

export default {
  name: 'BrokerPanel',
  components: { AlpacaConnectForm, IbkrConnectForm, Mt5ConnectForm, CTraderConnectForm, BrokerAccountCard, BrokerPositionsTable, BrokerOrdersTable },
  props: {
